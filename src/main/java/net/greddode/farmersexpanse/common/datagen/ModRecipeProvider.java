...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder
{
    ...
    protected void buildRecipes(RecipeOutput recipeOutput)
    {
        ...
        //MISC
        CookingPotRecipeBuilder.cookingPotRecipe(ModItemsFE.CHICKEN_NUGGET.get(), 2, FAST_COOKING, SMALL_EXP)
                .addIngredient(ModTagsFE.Items.FLOUR)
                .addIngredient(ModItems.CHICKEN_CUTS.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MISC)
                .unlockedBy("has_chicken_cuts", has(ModItems.CHICKEN_CUTS.get()))
                .save(recipeOutput);

        //Bacon Wrapped
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_WRAPPED_BEEF.get(), 1)
                .requires(Items.COOKED_BEEF)
                .requires(ModItems.COOKED_BACON.get())
                .unlockedBy("has_bacon", has(ModItems.COOKED_BACON.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_WRAPPED_PORKCHOP.get(), 1)
                .requires(Items.COOKED_PORKCHOP)
                .requires(ModItems.COOKED_BACON.get())
                .unlockedBy("has_bacon", has(ModItems.COOKED_BACON.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_WRAPPED_MUTTON.get(), 1)
                .requires(Items.COOKED_MUTTON)
                .requires(ModItems.COOKED_BACON.get())
                .unlockedBy("has_bacon", has(ModItems.COOKED_BACON.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_WRAPPED_CHICKEN.get(), 1)
                .requires(Items.COOKED_CHICKEN)
                .requires(ModItems.COOKED_BACON.get())
                .unlockedBy("has_bacon", has(ModItems.COOKED_BACON.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_WRAPPED_COD.get(), 1)
                .requires(Items.COOKED_COD)
                .requires(ModItems.COOKED_BACON.get())
                .unlockedBy("has_bacon", has(ModItems.COOKED_BACON.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_WRAPPED_SALMON.get(), 1)
        ...
        //Hamburger
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.PLAIN_HAMBURGER.get(), 1)
                .requires(Items.BREAD)
                .requires(ModItems.BEEF_PATTY.get())
                .unlockedBy("has_patty", has(ModItems.BEEF_PATTY.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.CHEESEBURGER.get(), 1)
                .requires(Items.BREAD)
                .requires(ModItems.BEEF_PATTY.get())
                .requires(ModItemsFE.CHEESE.get())
                .unlockedBy("has_patty", has(ModItems.BEEF_PATTY.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_CHEESEBURGER.get(), 1)
                .requires(Items.BREAD)
                .requires(ModItems.BEEF_PATTY.get())
                .requires(ModItemsFE.CHEESE.get())
                .requires(ModItems.COOKED_BACON.get())
                .unlockedBy("has_patty", has(ModItems.BEEF_PATTY.get()))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.DELUXE_HAMBURGER.get(), 1)
                .requires(Items.BREAD)
                .requires(ModItems.BEEF_PATTY.get())
                ...
                .requires(ModItemsFE.CHEESE.get())
                .requires(ModItems.COOKED_BACON.get())
                .requires(ModTagsFE.Items.CONDIMENTS)
                .unlockedBy("has_patty", has(ModItems.BEEF_PATTY.get()))
                .save(recipeOutput);

        //Sandwiches
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.PORK_SANDWICH.get(), 1)
                .requires(Items.BREAD)
                ...
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.MUTTON_SANDWICH.get(), 1)
                .requires(Items.BREAD)
                ...
                .unlockedBy("has_bread", has(Items.BREAD))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.COD_SANDWICH.get(), 1)
                .requires(Items.BREAD)
                ...
                .unlockedBy("has_bread", has(Items.BREAD))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.SALMON_SANDWICH.get(), 1)
                .requires(Items.BREAD)
                ...
                .unlockedBy("has_bread", has(Items.BREAD))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.VEGETABLE_SANDWICH.get(), 1)
                .requires(Items.BREAD)
                ...
                .unlockedBy("has_bread", has(Items.BREAD))
                .save(recipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItemsFE.BACON_AND_EGG_SANDWICH.get(), 1)
                .requires(Items.BREAD)
                .requires(ModItems.COOKED_BACON.get())
